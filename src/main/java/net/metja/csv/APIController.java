...
public class APIController {
    ...
    public ResponseEntity<String> index() {
        return new ResponseEntity<String>("<html><head><style>h1 { text-align: center }</style><title>CSV Service</title></head><body><h1>Hello Denmark!</h1></body></html>", HttpStatus.OK);
    }
